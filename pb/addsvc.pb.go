...
func (x *HealthCheckRequest) Reset() {
	*x = HealthCheckRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_addsvc_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HealthCheckRequest) Descriptor() ([]byte, []int) {
	return file_addsvc_proto_rawDescGZIP(), []int{4}
}
...
func (x *HealthCheckReply) Reset() {
	*x = HealthCheckReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_addsvc_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HealthCheckReply) Descriptor() ([]byte, []int) {
	return file_addsvc_proto_rawDescGZIP(), []int{5}
}

func (x *HealthCheckReply) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
var file_addsvc_proto_rawDesc = []byte{
	...
	0x03, 0x65, 0x72, 0x72, 0x22, 0x14, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x2a, 0x0a, 0x10, 0x48, 0x65,
	0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x16,
	0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x9b, 0x01, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12, 0x25,
	0x0a, 0x03, 0x53, 0x75, 0x6d, 0x12, 0x0e, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x75, 0x6d, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x75, 0x6d, 0x52, 0x65,
	...
	0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x3d, 0x0a, 0x0b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43,
	...
	0x62, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x22, 0x00, 0x42, 0x07, 0x5a, 0x05, 0x70, 0x62, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_addsvc_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_addsvc_proto_goTypes = []interface{}{
	...
	(*HealthCheckRequest)(nil), // 4: pb.HealthCheckRequest
	(*HealthCheckReply)(nil),   // 5: pb.HealthCheckReply
}
var file_addsvc_proto_depIdxs = []int32{
	0, // 0: pb.Add.Sum:input_type -> pb.SumRequest
	2, // 1: pb.Add.Concat:input_type -> pb.ConcatRequest
	4, // 2: pb.Add.HealthCheck:input_type -> pb.HealthCheckRequest
	1, // 3: pb.Add.Sum:output_type -> pb.SumReply
	3, // 4: pb.Add.Concat:output_type -> pb.ConcatReply
	5, // 5: pb.Add.HealthCheck:output_type -> pb.HealthCheckReply
...
func file_addsvc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_addsvc_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_addsvc_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
